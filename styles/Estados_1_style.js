...
var style_Estados_1 = function(feature, resolution){
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("nombre_Fie") !== null) {
        labelText = String(feature.get("nombre_Fie"));
    }
    if (value >= 8.540000 && value <= 53.290000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 53.290000 && value <= 112.470000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 112.470000 && value <= 211.020000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 211.020000 && value <= 678.960000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 678.960000 && value <= 5922.080000) {
            style = [ new ol.style.Style({
